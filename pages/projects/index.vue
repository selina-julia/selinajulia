...
<template>
    <div class="xl:pt-20">
        <div
            class="flex gap-x-40 mt-20 lg:mt-0 mb-20 lg:mb-40 xl:px-52 lg:w-8/12"
        >
            <div>
                ...
                <div class="lg:pl-16">
                    <p>
                        Während meines Studiums an der FH Hagenberg durfte ich
                        bereits einige Projekte im Bereich Design und
                        Entwicklung umsetzen. Darüber hinaus habe ich auch
                        bereits an ein paar Projekten im privaten Bereich
                        mitgewirkt. Ich stelle mich gerne neuen
                        Herausforderungen und lerne Neues kennen, besonders in
                        Sachen Frameworks und Design-Trends.
                    </p>
                </div>
            </div>
        </div>
        ...
        >
            ...
            >
                <div
                    ...
                    :class="{
                        'text-violet border-indigo-500': isCatSelected(cat)
                    }"
                    @click="filter(cat)"
                >
                    {{ cat }}
                    ...
                    posts: res.data.stories.map(
                        (post: {
                            ...
                            return {
                                ...
                                overviewCategories:
                                    post.content.overview_categories,
