    ...
    <div class="lg:mx-24">
      <div class="flex flex-col gap-y-5 lg:flex-row gap-x-5 mb-10">
        <div class="bg-indigo-50 p-10">
          ...
          <p>
            Egal, ob Websites mgit Wordpress oder Web Apps mit Angular oder
            React - ich bin für jede Herausforderung offen und stürze mich gerne
            mal in ein Projekt, um neue Bereiche der Web-Entwicklung zu
            erkunden.
          </p>
        </div>
        <div class="bg-indigo-50 p-10">
